...
class Go2AmpEnv(BaseTask):
    def __init__(self, cfg: Go2AMPCfg, sim_params, physics_engine, sim_device, headless):
        ...
        if self.cfg.env.reference_state_initialization:
            self.amp_loader = AMPLoader(motion_files=self.cfg.env.amp_motion_files, device=self.device, time_between_frames=self.dt, reorder=self.cfg.env.amp_motion_reorder)
